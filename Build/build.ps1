properties { 
  ...
  $builds = @(
    ...
    @{Name = "Newtonsoft.Json.XamariniOS"; TestsName = "Newtonsoft.Json.Tests.XamariniOS"; BuildFunction = "MSBuildBuild"; TestsFunction = "NUnitTests"; Constants="PORTABLE;IOS"; FinalDir="XamariniOS"; NuGetDir = "xamarinios10"; Framework="net-4.0"; Sign=$true},
